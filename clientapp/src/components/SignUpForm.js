...
export default function SignUpForm() {
    ...
    return (
        // <Formik initialValues={{email: '', shopName: ''}} onSubmit={() => console.log(vales)}>
            <Form style={{margin: 'auto', marginTop: 120, width: '50%'}} onSubmit={(e) => handleSubmit(e)}>
                <Form.Field>
